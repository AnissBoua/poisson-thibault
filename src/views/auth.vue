<template>
  <div class="flex flex-col h-screen">
    <div class="grid place-items-center mx-2 my-20 sm:my-auto">
      <div
        class="w-11/12 p-12 sm:w-8/12 md:w-6/12 lg:w-5/12 2xl:w-4/12 px-6 py-10 sm:px-10 sm:py-6 bg-neutral-700 rounded-lg shadow-md lg:shadow-lg"
      >
        ...
        <form @submit.prevent="login" class="mt-10" method="POST">
          <div class="my-2">
            <Input
              ...
              name="username"
              :value="username"
              @update:output="(value) => (username = value)"
            />
          </div>
          <div class="my-2">
            <Input
              ...
              type="password"
              :value="password"
              @update:output="(value) => (password = value)"
            />
          </div>
          <button
            type="submit"
            class="w-full py-3 mt-10 bg-neutral-800 rounded-md font-medium uppercase hover:bg-neutral-600"
          >
            Login
          </button>
